...
\item The real number k for which the equation, $2x^3+3x+4=0$ has two distinct real roots in [0,1]        \hfill\textbf{[JEE M 2013]}\\
	\begin{enumerate}[label=\alph*.]
...
\item If the equations $x^2+2x+3=0$ and $ax^2+bx+c=0$,a,b,c$\in$ R , have a   common   root , then a:b:c is
	...
	\end{multicols}
	\end{enumerate}
\item If a $\in$ R and the equation  $-3(x-[x])^2 +2(x-[x])+a^2 =0$ (where [x] denotes the greatest integer $\leq$ x) has no integral solution, then all possible values of a lie in the interval:            \hfill\textbf{[JEE M 2014]}\\
          \begin{enumerate}[label=\alph*.]
	  \begin{multicols}{2}
	  \item (-2,-1)
	  ...
	  \end{multicols}
	  \end{enumerate}
\item Let\quad$\alpha$ and $\beta$ be the roots of equation $px^2 + qx +r = 0$, $p\neq0$. If p,q,r are in A.P. and $\frac{1}{\alpha}+\frac{1}{\beta}=4$, then the value of $|\alpha-\beta|$ is
	\hfill\textbf{[JEE M 2014]}\\
	\begin{enumerate}[label=\alph*.]
	\begin{multicols}{2}
	\item $\frac{\sqrt{34}}{9}$
	\item $\frac{2\sqrt{13}}{9}$
	\item $\frac{\sqrt{61}}{9}$
	\item $\frac{2\sqrt17}{9}$
	\end{multicols}
	\end{enumerate}
...
\item Let p,q$\in$ R. If $2-\sqrt{3}$ is a root of the quadratic equation, $x^2+px+q=0$,then:
	\hfill\textbf{[JEE M 2019- 9 April(M)]}\\
	\begin{enumerate}[label=\alph*.]
	\begin{multicols}{2}
	\item $p^2-4q+12=0$
	\item $q^2-4p-16=0$
